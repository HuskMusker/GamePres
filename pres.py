...
if img_src:
    st.markdown(
        ...
        <img class="bg-image" src="{img_src}" alt="background">
        <div class="bg-overlay"></div>
        """,
        unsafe_allow_html=True
    )
else:
    # Если файл не найден, просто тёмный фон (можно и без картинки)
    st.markdown(
        """
        <style>
        .bg-overlay {
...
/* ★ ГЛАВНОЕ ИСПРАВЛЕНИЕ: прозрачный фон, чтобы были видны фоновое изображение и оверлей ★ */
.stApp {
