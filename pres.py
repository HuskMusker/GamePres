...
# ---------- МОДУЛЬ 1.2 ----------
    ...
    if step == 0:
        ...
        st.markdown("""
        <div class="bridge-block">
          <strong>📌 Мостик к разделу 1.3:</strong> Запомни, кто такой пользователь — это твои будущие клиенты, чьи данные ты будешь защищать в разделе 1.3.
        </div>
        """, unsafe_allow_html=True)
        ...
        <div class="theory-card">
          ...
          <p>В этом модуле вы научишься:</p>
          <ul>
...
# ---------- МОДУЛЬ 1.3 ----------
    ...
    if step == 0:
        ...
        if not st.session_state.m13_case_sent:
            ...
            st.markdown("#### Выберии вариант действий:")
            case_options = {
...
# ---------- ИТОГОВАЯ ДИАГНОСТИКА ----------
    ...
    st.markdown("""
    - Ты можешь сохранить свои ответы и проекты для портфолио.
    - Рекомендуем применять полученные знания на практике с реальными клиентами.
    - Следи за обновлениями в области кибербезопасности и регулярно повышай квалификацию.
    """)
